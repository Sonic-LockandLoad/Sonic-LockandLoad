...
The current stable version of Sonic: Lock & Load is **v1.3.3**, though it's recommended you play the **v1.4 Final Final Demo** instead. Well, that's what I would be saying if the Final Final Demo wasn't already super outdated. I would say it's recommended to `git clone` the repo and play that, buuuuuuuuut yeah that's not gonna be very stable.
